...
use Concrete\Package\Shortcodes\Controller\Dialog\Support\CreateTicket;
...
<form action="<?php echo (string)Url::to("/ccm/system/dialogs/shortcodes/create_ticket/submit"); ?>"
      data-dialog-form="create-ticket"
      method="post"
      enctype="multipart/form-data">

    <?php echo $form->hidden('projectHandle', "shortcodes"); ?>
